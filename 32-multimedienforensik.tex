...
\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Ablauf der Merkmalsextraktion von der JPEG-Datei bis zum Similarity Digest (Eigene Darstellung nach Klier und Baier\cite[Kap. 3]{klier_media_2025})}
