...
\begin{table}
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.2\linewidth}>{\raggedright\arraybackslash}p{0.75\linewidth}}\toprule\toprule
         \textbf{Studie}& Klier und Baier (2025)\cite{klier_media_2025}\\\hline
         \textbf{Verfahren}& MSSH (Media Source Similarity Hashing)\\\hline\hline
         \textbf{Untersuchungsziele}& SCI (Source Camera Identification auf Geräte-, Modell- und Markenebene, z. B. zur Unterscheidung von Downloads und Eigenproduktionen in CSAM-Ermittlungen) und SNA (Erkennung der Verarbeitung durch 5 Social-Media-Plattformen)\\\hline
         \textbf{Feature}& Strukturelle Marker und deren Reihenfolge (z. B. das 2-Gramm D8E1 aus den aneinandergereihten JPEG-Markern SOI und APP1)\\\hline
         \textbf{Symbolische Repräsentation} (T1 bis T5)& TODO\\\hline
         \textbf{Feature-Repräsentation}& n-Gramm-Sets (Similarity Digest)\\\hline
         \textbf{Feature-Selektion}& Dubletteneliminierung (reduziert die Sequenzen auf eine rein binäre Mengen-Repräsentation, Worthäufigkeiten werden ignoriert)\\\hline
         ...
         \textbf{Datenbanken}& 7 Bilddatensätze (u. A. VISION)\\\hline
         ...
         \textbf{Evaluation}&Klassifikation auf Geräte-, Modell- und Markenebene sowie Erkennung der Verarbeitung durch 5 Social-Media-Plattformen\\\hline
