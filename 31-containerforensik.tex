...
\begin{table}[htbp]
    \centering
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.5\linewidth}>{\raggedright\arraybackslash}p{0.44\linewidth}}\toprule\toprule
         ...
         Samsung SGH-D600& \(iods\)\\ \bottomrule\bottomrule
    \end{tabular}
...
\begin{table}
    \centering
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.05\linewidth}>{\raggedright\arraybackslash}p{0.12\linewidth}>{\raggedright\arraybackslash}p{0.31\linewidth}>{\raggedright\arraybackslash}p{0.4\linewidth}}\toprule\toprule
...
- Anfällig bei identischen Boxen\\\hline
         T5&  Ungeordnet&  Nur finales Feld sowie Wert und verwirft Struktur-Pfad komplett& - Vollständiger Verlust der Struktur-Infos\\ \bottomrule\bottomrule
    \end{tabular}
...
\begin{table}[H]
    \centering
    \begin{tabular}{>{\raggedright\arraybackslash}p{0.15\linewidth}>{\raggedright\arraybackslash}p{0.4\linewidth}>{\raggedright\arraybackslash}p{0.4\linewidth}}\toprule\toprule
 \textbf{Studie}& Yang u. a. (2020)&	
Xiang u. a. (2021)\\\hline
         \textbf{Verfahren}&  Quantitative Integritätsprüfung und Software-Identifikation durch Container-Charakterisierung&Forensische Analyse von MP4-Metadaten durch vektorielle Repräsentation und Dimensionsreduktion\\\hline\hline
         \textbf{Unter-suchungs-ziele}&  MD (Manipulationserkennung), MTI (Software-Identifikation), SNA (Social-Media-Erkennung) und rudimentär SCI (Erkennung des Betriebssystems)&SCI (Brand Attribution), MTI (Software-Identifikation), SNA (Social-Media-Erkennung) und MD (Manipulationserkennung)\\\hline
         \textbf{Feature}&  Field (Pfade) und Value (Pfade inklusive Werte) aus der Baumstruktur&Boxen sowie Felder, die als track-spezifische Features extrahiert werden\\\hline
         \textbf{Symbolische Repräsentation} (T1 bis T5)&  \multicolumn{2}{c}{T4 (ungeordnet, extrahiert pfadrelevante Informationen, ignoriert Reihenfolge)}\\\hline
         \textbf{Feature-Repräsentation}&  Bag-of-Words&Type-aware-Model\\\hline
         \textbf{Feature-Selektion}&  	
Likelihood-Ratio-Framework &Korrelationsmatrix und spektrales Clustering \\\hline
         \textbf{Klassifikator}&  Entscheidungsbäume &Linear Discriminant Analysis (LDA) mit Nearest Neighbor Classifier (NNC) für Multi-Klassen; Entscheidungsbäume für binäre Klassen\\\hline
         \textbf{Datenbanken}&  \multicolumn{2}{c}{VISION und EVA-7K}\\\hline
         \textbf{Test- und Trainingsdaten}&  Leave-one-device-out Kreuzvalidierung (34 Folds)&50/50 Split mit stratifiziertem Sampling sowie Leave-one-out Kreuzvalidierung für lokale Videos\\\hline
         \textbf{Evaluation}& Unterscheidung von nativen und manipulierten Videos, 4 Social-Media-Plattformen&Brand Attribution, Software-Identifikation, 4 Social-Media-Plattformen und Integritätsprüfung\\\hline
         \textbf{Metriken}& \multicolumn{2}{c}{Balanced Accuracy, True Positive Rate (TPR), True Negative Rate (TNR)}\\ \bottomrule\bottomrule
    \end{tabular}
...
Ramos López u. a. (2020)\\\hline
         \textbf{Verfahren}&  Unüberwachte Container-Analyse mittels Dissimilarity-Metrik und Likelihood-Ratios&Unüberwachte Videoquellen-Identifikation mittels hierarchischer und dichtebasierter Clustering-Algorithmen\\\hline\hline
         \textbf{Unter-suchungs-ziele}&  MD, SCI&SCI, SNA\\\hline
         \textbf{Feature}&  Field und Values inklusive absoluter Pfade (z. B. moov-2/udta-2/count)&Field und Value der Boxen in vier Variationen (mit und ohne Pfad: PathField, PathFieldValue, PathOrderField, PathOrderFieldValue)\\\hline
         \textbf{Symbolische Repräsentation} (T1 bis T5)&  T2&T2, T4\\\hline
         \textbf{Feature-Repräsentation}&  Mengen-Repräsentation (Berechnung der prozentualen Nicht-Übereinstimmung / Mismatching Percentage)&Distanz-Matrizen\\\hline
         \textbf{Feature-Selektion}&  	
Manueller Ausschluss volatiler Metadaten&Manueller Ausschluss volatiler Metadaten\\\hline
         \textbf{Klassifikator}&  Schwellenwert-basierter Vergleich (Dissimilarity) und Likelihood-Ratio-Test&Unüberwachte Clustering-Algorithmen \\\hline
         \textbf{Datenbanken}&  VISION&VISION, ACID\\\hline
         \textbf{Test- und Trainingsdaten}&  Referenzvergleich (1-zu-1 für MD) und Likelihood-Berechnung mit klassenspezifischen Trainingsdaten (für SCI)&Unüberwachtes Clustering ohne vorheriges Training (Open-Set-Szenario)\\\hline
         \textbf{Evaluation}& Unterscheidung nativer vs. bearbeiteter Videos sowie Brand Attribution&Clustering nach Marke, Modell, Gerät sowie Social Media \\\hline
         \textbf{Metriken}& AUC&Silhouette Coefficient, Homogeneity, Completeness, Rand Index (RI)\\ \bottomrule\bottomrule
    \end{tabular}
