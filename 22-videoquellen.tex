...
\begin{figure}[h]
    ...
    \end{forest}
    \caption{MP4-Atom-Struktur von AI01 (Google Flow OmniFlash, SYNTHETIC, MP4, ORIGINAL), farblich gruppiert nach uuid-Manifest (violett), Video-Track (blau), Audio-Track (grün), Metadaten (orange) und Mediendaten (rot) (Eigene Darstellung)}
    \label{fig:tree_ai01}
\end{figure}
