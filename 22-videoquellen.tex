...
\begin{figure}[h]
    ...
    [AI01\_01\_\\synth.mp4, align=center
        ...
        [moov
            [mvhd]
            [trak (video), for tree={fill=blue!15, draw=blue!60}
                [tkhd]
                [edts [elst]]
                [mdia
                    [mdhd]
            ...
            [trak (audio), for tree={fill=green!15, draw=green!60}
                [tkhd]
                [edts [elst]]
                [mdia
                    [mdhd]
    ...
    \end{forest}
    \caption{MP4-Box-Struktur von AI01 (Google Flow OmniFlash, SYNTHETIC, MP4, ORIGINAL), farblich gruppiert nach uuid-Manifest (violett), Video-Track (blau), Audio-Track (grün), Metadaten (orange) und Mediendaten (rot) (Eigene Darstellung)}
    \label{fig:tree_ai01}
\end{figure}
